...
export default function SplashPage({ onEnter }) {
  return (
    <div style={{ width:1280, height:720, background:'#000', position:'relative', overflow:'hidden' }}>
      ...
      <button
        onClick={onEnter}
        style={{ all:'unset', color:'rgba(255,255,255,0.8)', fontSize:13, fontWeight:400, lineHeight:'150%', letterSpacing:'0.08em', textTransform:'uppercase', position:'absolute', left:30, bottom:29, width:626, cursor:'pointer', display:'flex', alignItems:'flex-end', gap:12, transition:'opacity .25s' }}
