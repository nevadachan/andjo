...
export default function NavPage({ onSelectDash }) {
  ...
  return (
    <div style={{ width:1280, height:720, background:'#000', position:'relative', overflow:'hidden', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(40px)', transition:'opacity .7s ease, transform .7s ease' }}>
